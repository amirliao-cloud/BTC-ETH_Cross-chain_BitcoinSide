...
def atomic_swap_output_script(len_secret_byte, hash_of_secret, public_key_sender, public_key_recipient, lock_time_byte):
    '''Takes a hash160 and returns the atomic swap ScriptPubKey'''
    return Script([0x63,
                   0X82, len_secret_byte, 0x88,
                   0xa9, hash_of_secret, 0x88,
                   0x76, 0xa9, public_key_recipient,
                   0x67,
                   lock_time_byte, 0xb1, 0x75,
                   0x76, 0xa9, public_key_sender,
                   0x68,
                   0x88,
                   0xac])

# note that only the op cmd can use int, the other data should use int_to_little_endian to convert to byte or byte array.
# ScriptPubKey:
# OP_IF // Normal redeem path
# 	OP_SIZE <secretSize> OP_EQUALVERIFY
# 	OP_HA160 <secretHash> OP_EQUALVERIFY
# 	OP_DUP OP_HASH160 <bob's pubkey hash>
# OP_ELSE // Refund path
#  <locktime> OP_CHECKLOCKTIMEVERIFY OP_DROP
# 	OP_DUP OP_HASH160 <alice's pubkey hash>
# OP_ENDIF
# OP_EQUALVERIFY
# OP_CHECKSIG

# example of script formation
# multisig script: 2 0307fd375ed7cced0f50723e3e1a97bbe7ccff7318c815df4e99a59bc94dbcd819 0367c4f666f18279009c941e57fab3e42653c6553e5ca092c104d1db279e328a28 2 OP_CHECKMULTISIG
# 0x52 = OP_2
...
class ScriptTest(TestCase):
    ...
    def test_serialize(self):
        # want = "a91472b7d720c107e3afc08feb69b4bab268391ba05087"
